...
## 챌린지
1. 웹 성능 최적화.
- 웹 성능을 더욱 개선하기 위해 추가적인 최적화 작업을 검토 해봤습니다.
...
2. 로딩 스피너 추가.
- 문제점.
  - 예약을 작성하고 제출하는 동안 로딩이 발생할 때 사용자에게 진행 상황을 시각적으로 알려주지 않아, 사용자가 다시 한 번 예약을 하거나 다른 작업을 할 가능성이 높아졌습니다.
